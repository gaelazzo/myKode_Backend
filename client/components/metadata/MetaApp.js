...
(function () {
    ...
    MetaApp.prototype = {
         ...
         */
        init: function() {
            //console.log("running MetaApp.init");
            this.appvar = {};
        ...
        start:function () {
            if (!appMeta.globalEventManager){
                //console.log("assigning globalEventManager from start()");
        ...
        callPage: function(metaToCall, editType, wantsRow) {
            //console.log("calling page "+metaToCall+":"+editType);
            //console.log("this.currentMetaPage: ",typeof (this.currentMetaPage));
            let self = this;
            let createdPage;
            ...
            // se apro una nuova pagina principale, mi assicuro che io possa chiudere la precedente.
            return appMeta.utils._if (this.currentMetaPage
                )._then(function(){
                    //console.log("callPage entering _if");
                    return appMeta.utils._if(!wantsRow)._then(
                        function(){
                            // console.log("callPage closing soon");
                        ...
                        function(){
                                 // console.log("callPage closing not too soon");
                  ...
                  ()=>{
                    // console.log("callPage: row was wanted");
                    // esco se non posso chiudere la precedente, perché magari ci sono modifiche e l'utente deve prima accettare
                    if (!canOpenPage){
                        return;
                    }
                    // console.log("to get MetaPage");
                    return appMeta.getMetaPage(metaToCall, editType).then(function (calledMetaPage){
