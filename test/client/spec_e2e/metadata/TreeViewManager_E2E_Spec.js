                ...
                it("start() method retrieve tree row structure of finview", function (done) {
                    ...
                    defLogin.
                        then(() => {
                            ...
                            // configura var ausilairie, lo state serve in helpForm, il quale è passato nel costruttore di treeViewManger
                            ...
                            //var filter = q.or(q.eq("idfin",12), q.eq("idfin",13), q.eq("idfin",18), q.eq("idfin",450),q.eq("idfin",9),
                             //      q.eq("idfin",50), q.eq("idfin",1),  q.eq("idfin",2), q.eq("idfin",309));
