...
describe('MetaPage e2e', function () {
    ...
    beforeEach(function () {
        ...
        jasmine.getFixtures().fixturesPath = 'base/test/client/spec/fixtures';
                ...
                function () {
                                    ...
                                    .then(function(res) {
                                        ...
                                        metapage.cmdMainDoSearch(appMeta.localResource.maindosearch, "registry.anagrafica")
                                            .then(function (result) {
                                                    ...
                                                    expect($('#txtBox2').val()).toBe("008000000000002"); // valore di p_iva che torna dal db in base ai criteri scelti
                    ...
                    it('freshform(true, true, "notExistTableName") is ASYNC and not fill data, cause notExistTableName', function (done) {
                        defLogin.then(function () {
                            ...
                            metapage.init().then(function (result) {
                                metapage.state.meta  = new appMeta.MetaData(tableName);
                                appMeta.getData.fillDataSet(metapage.state.DS, tableName, "anagrafica", filterMain)
                                .then(function () {
                                    return metapage.helpForm.preScanControls();
                                })
                                .then(() => {
                                    ...
                                    metapage.freshForm(true, true, "notExistTableName").then(function () {
                                        expect( $("#combo1 option").length).toBe(4);
                                        expect( $("#combo2 option").length).toBe(2);
                                        done();
                                    });
                                });
                            ...
                            defLogin.then(function () {
                                ...
                                conn.call(objConn)
                                    .then(function(res) {
                                        ...
                                        // imposto filtro sulla chiave, con varie righe restituite
