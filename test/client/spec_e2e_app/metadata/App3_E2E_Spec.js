                    ...
                    loadRegistry(1)
                        .then(function(metaPage) {
                            ...
                            common.pageEventWaiter(metaPage, appMeta.EventEnum.ROW_SELECT).then(function () {
                                ...
                                let ds = metaPage.state.DS;

                                //sul db: 2017-12-11 13:21:38.890
                                expect(ds.tables["registry"].rows[0].lt).toEqual(new Date("2017-12-11T12:21:38.890Z"));
                                ...
                                testHelper.waitEvent(appMeta.EventEnum.showPage)
                                    .then(function (metaPageDetail) {
                                        ...
                                        // console.log("Old value was "+valInit)
                                        // console.log("New value is "+valueEdit)
                                        ...
                                        //let valFound = $("input[data-tag='registryreference.referencename']").val();
                                        // console.log("New found value is "+valFound)
                                        ...
                                        .then(function () {
                                            ...
                                            // Dopo il close attendo messaggio di warning modifiche non salvate. Premo ok
                                            common.pageEventWaiter(metaPage, appMeta.EventEnum.showModalWindow).then(
                                                function () {
                                                    allCheckExecuted++;
