...
describe('App1_E2E', function() {
    ...
    describe("App Form Activation + Search row + Autochoose + ShowLast",
        function() {
            ...
            it('B 1. callPage() table:registry, editType:anagrafica" should be async and return data. ' + "\n" +
            ...
            it('C 1. callPage() table:registry, editType:anagrafica" should be async and return data. ' + "\n" +
            ...
            it('D 1. callPage() table:registry, editType:anagrafica" should be async and return data. ' + "\n" +
                '2. Invokes maindosearch -> form filled'  + "\n" +
            ...
            it('E 1. callPage() table:registry, editType:anagrafica" should be async and return data. ' + "\n" +
            ...
            it('F 1. callPage() table:registry, editType:anagrafica" should be async and return data. ' + "\n" +
                        ...
                        .then(function (metaPage) {
                            ...
                            let s = common.pageEventWaiter(metaPage, appMeta.EventEnum.showModalWindow)
                                .then(function () {
                                    ...
                                    appMeta.logger.setLogLevel(appMeta.logTypeEnum.ERROR)
