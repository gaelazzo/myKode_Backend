(function () {
    ...
    Common.prototype = {
        ...
        getRegistryAnagraficaMockDataSetFilled:function () {
            let jsonPath = "base/test/client/spec_midway/jstest/registry_anagrafica._rtf_null_cu_sa.json" ;
            // var jsonPath = "../../../test/spec_midway/jstest/registry_anagrafica._rtf_null_cu_sa.json" ;
            let json = $.getJSON({'url': jsonPath, 'async': false});
            let ds = appMeta.getDataUtils.getJsDataSetFromJson(json.responseText);
            return ds;
