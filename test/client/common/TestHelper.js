(function () {
	...
	TestHelper.prototype = {
		...
		initAppTests: function (pathRelativeOfTest) {
			...
			appMeta.basePath = 'base/test_client/spec_e2e_app/' + pathRelativeOfTest + '/'; //qui si trovano le metapage
			...
			$("body").append('<link rel="stylesheet" href="base/test_client/app/styles/app.css" />');
		...
		initAppTestProduction: function (appfolder) {
			...
			appMeta.basePathMetadata = 'base/test_client/test/client/spec_e2e_app/' + appfolder + '/metadata/';
			//console.log("assigned basePathMetadata = "+appMeta.basePathMetadata);
			appMeta.config.path_maintoolBarTemplate = "base/test_client/components/userTemplate/mainToolBar_Template.html";
			...
			$("body").append('<link rel="stylesheet" href="base/test_client/' + appfolder + '/styles/italia/bootstrap-italia.min.css" />');
			$("body").append('<link rel="stylesheet" href="base/test_client/' + appfolder + '/styles/italia/italia-icon-font.css" />');
			$("body").append('<link rel="stylesheet" href="base/test_client/' + appfolder + '/styles/custom.css" />');
			$("body").append('<link rel="stylesheet" href="base/test_client/components/styles/app.css" />');
			$("body").append('<link rel="stylesheet" href="base/test_client/components/styles/jquery.toast.css" />');
