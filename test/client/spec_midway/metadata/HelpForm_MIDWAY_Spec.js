                    ...
                    function (){
                        ...
                        it("SELECT - Change Event 2",
                            function (done){
                                ...
                                dmaster.isTemporaryTable = false;
            ...
            function (){
                ...
                it('focus field on tab nested',
                    function (done){
                        ...
                        jasmine.getFixtures().fixturesPath = 'base/test/client/spec_midway/fixtures';
                        ...
                        .then(()=> {
                            ...
                            $("head").append('<script src="/base/client/bower_components/bootstrap/dist/js/bootstrap.bundle.js"></script>');
