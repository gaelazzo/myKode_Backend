...
function getDataSetCustomerWithPhone() {
    var ds = new DataSet('customer2'),
        ...
        customerview = ds.newTable('customerview'),
        customerphone = ds.newTable('customerphone');

    customerview.setDataColumn("idcustomer",CType.int);
    customerview.setDataColumn("idcustomerkind",CType.int);
    customerview.setDataColumn("customer",CType.string);
    customerview.setDataColumn("customerkind",CType.string);

    customer.setDataColumn("idcustomer",CType.int);
    customer.setDataColumn("data_customer",CType.int);


    customer.setDataColumn("col1",CType.int);
    customer.setDataColumn("col2",CType.int);
    customer.setDataColumn("col3",CType.string);

    customerphone.setDataColumn("idcustomer", CType.int);
    customerphone.setDataColumn("idcustomerphone",CType.int);
    customerphone.setDataColumn("data_customerphone",CType.string);
    customerphone.setDataColumn("col1",CType.string);
    customerphone.setDataColumn("col2",CType.string);
