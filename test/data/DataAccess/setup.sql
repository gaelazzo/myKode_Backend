...
set @i=1;
while @i < 500 DO
insert into customer(idcustomer,name,age,birth,surname,stamp,random,curr,cat,cat20,big_num,small_num) values(
			 @i,
...
set @i=1;
while (@i<600) DO
insert into seller (idseller,name,age,birth,surname,stamp,random,curr,cf,big_num,small_num) values(
			 @i,
