 ...
 *  }
 */
const configName = path.join('test', 'data','BusinessLogic', 'db.json');
let dbConfig;
...
describe('js prerequisites', function () {
    ...
    it("checking sequence of deferred returning functions", function (done) {
        let arr=[];
        let f=null;
        let returnDef = (x)=> {arr[x]=x; return Deferred().resolve(x);};
        for (let i = 0;i < 10; i++) {
    ...
    it("checking sequence of deferred returning functions with some fail", function (done) {
        ...
        let f=null;
        let returnDef = (x)=> {arr[x]=x; return Deferred().resolve(x);};
        let returnFail = (x)=> { return Deferred().reject(x);};
        let fun = function (i){
            if (i===5){
                return returnDef(i);
            }
...
describe("BusinessLogic",function() {
    ...
    describe("parametersFor", function () {
        it("should evaluate an array of parameters", function () {
        ...
        it("should not append autoincrement columns as parameters if state added", function () {
            let ds = dsProvider("customerphone");
            let tCustomer = ds.tables["customer"];
            let tCustomerPhone = ds.tables["customerphone"];
            let rCustomer1 = tCustomer.newRow({idcustomer: 1});
        ...
        it("should  append autoincrement columns as parameters if state not added", function () {
            let ds = dsProvider("customerphone");
            let tCustomer = ds.tables["customer"];
            let tCustomerPhone = ds.tables["customerphone"];
            let rCustomer1 = tCustomer.newRow({idcustomer: 1});
        ...
        it("should select messages based on sp result ",function (done){
            ...
            spyOn(context.getDataSpace, 'getStartingFrom').and.callFake(
                ...
                function (context, tableOp) {
                    ...
                    auditCheckView.newRow({idaudit: 'audit00', idcheck: 1, severity: 'E', message: 'audit00 on customer %<customer.col1>%',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit02', idcheck: 1, severity: 'E', message: 'audit02 on customer %<customer.col1>%',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit04', idcheck: 1, severity: 'E', message: 'audit04 on customer %<customer.col1>%',tablename:'customer',opkind:'I',sqlcmd:null,precheck:'N'});//sql null
                    auditCheckView.newRow({idaudit: 'audit03', idcheck: 1, severity: 'E', message: 'audit03 on customer %<customer.col1>%',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit01', idcheck: 1, severity: 'E', message: 'audit01 on customer %<customer.col1>%',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'S'});//precheck

                    auditCheckView.newRow({idaudit: 'audit00', idcheck: 1, severity: 'E', message: 'audit00 on customerphone %<customerphone.col1>% %<customerphone.col2>%',tablename:'customerphone',opkind:'I',sqlcmd:'dummy',precheck:'N'});
        ...
        it("should merge identical messages ",function (done){
            ...
            spyOn(context.getDataSpace, 'getStartingFrom').and.callFake(
                ...
                function (context, tableOp) {
                    ...
                    let /*DataTable*/ auditCheckView = dsRules.tables["auditcheckview"];
                    auditCheckView.newRow({idaudit: 'audit00', idcheck: 1, severity: 'E', message: 'error on customer',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit02', idcheck: 1, severity: 'E', message: 'error on customer',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit04', idcheck: 1, severity: 'E', message: 'error on customer',tablename:'customer',opkind:'I',sqlcmd:null,precheck:'N'});//sql null
                    auditCheckView.newRow({idaudit: 'audit03', idcheck: 1, severity: 'E', message: 'error on customer',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit01', idcheck: 1, severity: 'E', message: 'error on customer',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'S'});//precheck

                    auditCheckView.newRow({idaudit: 'audit00', idcheck: 1, severity: 'E', message: 'error on customerphone',tablename:'customerphone',opkind:'I',sqlcmd:'dummy',precheck:'N'});
        ...
        it("should call parametersFor for every RowChange", function (done) {
            ...
            spyOn(context.getDataSpace, 'getStartingFrom').and.callFake(
                ...
                function (context, tableOp) {
                    ...
                    let /*DataTable*/ auditCheckView = dsRules.tables["auditcheckview"];
                    auditCheckView.newRow({idaudit: 'audit00', idcheck: 1, severity: 'E', message: 'Error 1',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit02', idcheck: 1, severity: 'E', message: 'Error 2',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit04', idcheck: 1, severity: 'E', message: 'Error 2',tablename:'customer',opkind:'I',sqlcmd:null,precheck:'N'});//sql null
                    auditCheckView.newRow({idaudit: 'audit03', idcheck: 1, severity: 'E', message: 'Error 3',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'N'});
                    auditCheckView.newRow({idaudit: 'audit01', idcheck: 1, severity: 'E', message: 'Error 2',tablename:'customer',opkind:'I',sqlcmd:'dummy',precheck:'S'});//precheck

                    auditCheckView.newRow({idaudit: 'audit00', idcheck: 1, severity: 'E', message: 'Error p1',tablename:'customerphone',opkind:'I',sqlcmd:'dummy',precheck:'N'});
